...
public interface ApiInterface {
    ...
    @GET("movie/{id}/videos")
    Call<TrailerResponse> loadTrailers(@Path("id")  Integer id, @Query("api_key") String api_key);

    @GET("movie/{id}/reviews")
    Call<ReviewResponse> loadReviews(@Path("id") Integer id, @Query("api_key") String api_key);
